...
const Navbar = () => {
    ...
    return (
        <header className='fixed top-0 left-0 w-full bg-gray-900 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-blue-400'>
                ...
                <nav className='flex flex-wrap items-center gap-4'>
                    <Link to={"/"} className='text-gray-300 hover:text-emerald-400 transition duration-300
					 ...
					 ease-in-out' >
                                ...
                                {cart.length > 0 && (<span className='absolute -top-2 -left-2 bg-blue-400 text-white rounded-full px-2 py-0.5 
                        ...
                        {isAdmin && (
                            <Link className='bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-md font-medium
